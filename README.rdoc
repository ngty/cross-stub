...
The following describes all available cache stores available:
...
Adding new stores is super easy (w.r.t testing & actual implementation), let me know if u need more :]
